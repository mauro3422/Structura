...
import { renderBackButton, renderPageHeader, renderPageShell } from '../components/templates.ts';
import { installMagicTriggerBridge } from './lesson/triggers.ts';
import { renderLessonSection } from './lesson/sectionRenderer.ts';

export function renderLesson(params: { id: string }) {
